...
public class OperationRunnable implements Runnable {
    ...
    public void run() {
        ...
        LOGGER.log("Starting thread = " + Thread.currentThread().getName() + " - " + holder.toString());
        ...
        LOGGER.log("Finishing thread = " + Thread.currentThread().getName() + " - " + holder.toString());
        LOGGER.log(repository.get().toString());
